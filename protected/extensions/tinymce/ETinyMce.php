...
class ETinyMce extends CInputWidget
{
    ...
    * @var string
    */
   public $editorTemplate = 'advanced';
   ...
   *
    ...
    * @var string
    */
   private $contentCSS = '/static/css/tinymce.css';
    ...
    * @var array
    */
   private $validEditorTemplates = array('simple', 'advanced', 'full');
   ...
   protected function makeAdvancedEditor()
   {
      $options = array();
      ...
      $options['file_browser_callback'] = 'myCustomFileBrowser';
      $options['theme'] = 'advanced';
      $options['theme_advanced_toolbar_location'] = 'top';
      $options['theme_advanced_toolbar_align'] = 'left';
      $options['theme_advanced_path_location'] = 'bottom';

		$options['theme_advanced_buttons1'] = "styleselect,fontsizeselect,formatselect,|,forecolor,|,bold,italic,underline,strikethrough,|,pastetext,pasteword,|,sub,sup";
		$options['theme_advanced_buttons2'] = "undo,redo,|,tablecontrols";
		$options['theme_advanced_buttons3'] = "justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,charmap,image,media,|,link,unlink,anchor,|,code";
	  ...
	  $options['style_formats'] = array(
			array('title'=> "h1", 'block'=> "div", 'classes'=> "h1"),
			array('title'=> "h3", 'block'=> "div", 'classes'=> "h3"),
			array('title'=> "h5", 'block'=> "div", 'classes'=> "h5"),
			array('title'=> "radius5", 'inline-block'=> "span", 'classes'=> "radius5"),
			array('title'=> "show-hide-link", 'inline'=> "span", 'classes'=> "show-hide-link"),
			array('title'=> "show-hide-block", 'block'=> "div", 'classes'=> "show-hide-block"),
		);
	...
	protected function makeOptions($url='')
	{
      ...
      if ($this->editorTemplate !== '') {
         switch ($this->editorTemplate) {
            ...
            break;
            case 'advanced':
               $template = $this->makeAdvancedEditor();
            break;			
            case 'full':
...
EOP;
	  ...
	  $cs->registerScriptData('assets_uid',array('assets'=>$assets,'uid'=>Yii::app()->user->id),0);
	  $cs->registerScriptData('assets_uid',array('assets'=>$assets,'object'=>Yii::app()->controller->id),0);
