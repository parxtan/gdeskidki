...
/**
 * This is the model class for table "tbl_text".
 *
 * The followings are the available columns in table 'tbl_text':
 * @property integer $id
...
class Text extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('rubric_id', 'required'),
			array('rubric_id', 'numerical', 'integerOnly'=>true),
			array('text', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, rubric_id, text', 'safe', 'on'=>'search'),
		);
	}
