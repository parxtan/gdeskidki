...
class Instagram
{
  public function SendRequest($url, $post, $post_data, $user_agent, $cookies) {
    ...
    if($cookies) {
        curl_setopt($ch, CURLOPT_COOKIEFILE, $_SERVER['DOCUMENT_ROOT'].'/userdata/cookies.txt');
    } else {
        curl_setopt($ch, CURLOPT_COOKIEJAR, $_SERVER['DOCUMENT_ROOT'].'/userdata/cookies.txt');
    }
